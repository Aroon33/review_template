...
* Fixed some minor issues in gutenberg template.

@Version 0.2.5.7.2
* Added footer widget layouts in PRO.

@Version 0.2.5.7.1
* Update the tag.

@Version 0.2.5.7
* Added content layout setting in PRO.
...
@Version 0.2.5.3
* Added Page title settings on single page.
