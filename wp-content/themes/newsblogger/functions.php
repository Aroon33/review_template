                ...
                <div class="notice-content-wrap">
                    <div class="notice-content">
                        ...
                        <ol class="admin-notice-up-list">
                            <li><?php echo "Added WooCommerce header variation."; ?></li>
                        </ol>
...
/**
 * ブログ一覧（post）に review 投稿も混ぜて表示する
 */
function nb_include_reviews_in_blog( $query ) {
    ...
    // ブログトップ（「投稿ページ」）だけ review を混ぜる
    if ( $query->is_home() ) {

        // post と review を一緒に表示
        $query->set( 'post_type', array( 'post', 'review' ) );
    }
}
add_action( 'pre_get_posts', 'nb_include_reviews_in_blog' );
